...
- **ทำไมต้องมี** — กำไรกับเงินสดเป็นคนละตัวเลข ปีที่กำไรเป็นบวกแต่เงินสดติดลบเกิดได้ เมื่อค่าเสื่อมสูงหรือเงินก้อนถูกจ่ายออกไปในปีนั้น ตัวเลขสองตัวนี้ตอบคนละคำถาม
...
- **ทำไมต้องมี** — บอกเป็นกิโลว่าต้องขายเท่าไรค่าใช้จ่ายทั้งฤดูจึงพอดี ถ้าอยากรู้ว่าราคาตกได้แค่ไหน ให้ดูที่เงินเหลือต่อกิโล ไม่ใช่ตัวนี้
...
- **ใช้ยังไง** — คูณกับผลผลิตที่ขายได้ ก็คือรายได้ทั้งฤดู ราคานี้ขยับตามสองอย่างที่กรอกไว้ ราคาของแต่ละเกรด และสัดส่วนของแต่ละเกรด เปลี่ยนอย่างใดอย่างหนึ่ง ตัวนี้เปลี่ยนตาม
...
- **ทำไมต้องมี** — ถ้าตัวนี้ติดลบ ทุกกิโลที่ขายเพิ่มทำให้ยอดรวมติดลบมากขึ้น ตัวเลขนี้อ่านได้จากราคาและค่าใช้จ่ายที่กรอกไว้ ก่อนฤดูจะเริ่ม
...
- **ใช้ยังไง** — ต่ำกว่าร้อยคือมีคำสั่งซื้อที่รับไม่ไหว เกินร้อยคือมีของที่ยังไม่มี
  คนรับ ตัวเลขบอกแค่ว่าอยู่ทางไหนและห่างเท่าไร
...
- **ใช้ยังไง** — ใส่ปุ๋ยเพิ่มแล้วตัวนี้ตกลง แปลว่าผลผลิตต่อกิโลปุ๋ยลดลง ตัวเลขบอกแค่นั้น ไม่ได้บอกว่าเพราะอะไร
...
- **ใช้ยังไง** — ส่วนใหญ่คือค่าสูบน้ำ ถ้าหน่วยไฟเพิ่มโดยที่ผลผลิตไม่เพิ่ม ตัวนี้จะตก ตัวเลขบอกแค่ว่าตกหรือขึ้น ไม่ได้บอกว่าเพราะอะไร
...
- **คืออะไร** — ของที่หายไประหว่างทางก่อนถึงมือผู้ซื้อ คิดเป็นกี่เปอร์เซ็นต์ของ
  ผลผลิตทั้งหมด
- **ใช้ยังไง** — ตัวนี้ลดลง ผลผลิตที่ขายได้จะเพิ่มโดยไม่ต้องเก็บมากขึ้น และมันไม่ได้กระทบแค่ตัวมันเอง เพราะผลผลิตที่
