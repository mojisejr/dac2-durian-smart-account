...
เปิดแอป
  ...
  │                                └─ [สมัครใหม่] → อีเมล + รหัสผ่าน → เข้าใช้ได้ทันที
  │
...
### Still needing wording

`ราคาขายเฉลี่ยถ่วงน้ำหนัก` · `ต้นทุนผันแปร กับ ต้นทุนคงที่` ·
`ส่วนเกินต่อหน่วย` · `ROI` · `ระยะคืนทุน` · `ตอบสนองตลาด` ·
`เป้าหมาย KPI แต่ละตัว` · `ภาษี สองวิธี` · `คะแนนสุขภาพธุรกิจ` ·
`สัดส่วนพึ่งพาผู้ซื้อรายใหญ่`
