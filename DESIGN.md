...
- **ไม่ใส่ได้ไหม** — ถ้าไม่กรอกฐานเงินลงทุนในหน้าต้นทุนคงที่ ตัวนี้จะไม่ขึ้น และ
  จะไม่เดาให้ เพราะการเดาฐานลงทุนคือการเดาว่าคุณจมเงินไปเท่าไร ซึ่งไม่มีใครรู้แทน
  กันได้
...
- **ไม่ใส่ได้ไหม** — คำนวณจากฐานเงินลงทุนหารด้วยกระแสเงินสด ถ้ากระแสเงินสดเป็นศูนย์
  หรือติดลบ ตัวนี้จะไม่ขึ้น ซึ่งถูกแล้ว เพราะเงินที่ไม่ไหลเข้าไม่มีวันคืนทุน
