...
pub struct CostAnalysis {
    ...
    pub manual_fixed_cost: Option<Decimal>,
    pub asset_depreciation: Option<Decimal>,
    pub fixed_cost: Option<Decimal>,
    pub cash_fixed_cost: Option<Decimal>,
    pub manual_investment_base: Option<Decimal>,
    pub asset_investment_base: Option<Decimal>,
